...
.. only:: port_openmvcam
   ...
   .. function:: hard_reset()
      ...
      Resets the openmvcam in a manner similar to asserting the external RESET.

   .. function:: bootloader()

       Activate the bootloader without BOOT pin.
...
.. only:: port_openmvcam
    ...
    .. function:: freq([sysclk[, hclk[, pclk1[, pclk2]]]])
       ...
       Supported sysclk frequencies are (in MHz): 8, 16, 24, 30, 32, 36, 40, 42, 48,
       54, 56, 60, 64, 72, 84, 96, 108, 120, 144, 168, 192, 216.
    ...
    .. function:: standby()
       ...
       Put the openmvcam into a "deep sleep" state.
