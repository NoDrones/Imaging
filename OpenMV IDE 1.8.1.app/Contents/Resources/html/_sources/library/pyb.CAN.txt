...
.. only:: port_openmvcam
    ...
    .. class:: pyb.CAN(bus, ...)
       ...
       The physical pins of the CAN buss are:
...
.. classmethod:: CAN.initfilterbanks(nr)
    ...
    .. only:: port_openmvcam
       ...
       Reset and disable all filter banks and assign how many banks should be available for CAN(2).

       ``nr`` is the number of banks that will be assigned to CAN(2). At boot, 14 banks are assigned to CAN(2).
